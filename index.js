...
const keys = [
  [
    ...
    { id: 'Digit3', en: { text: '3', textShift: '#', textCaps: '3' }, ru: { text: '3', textShift: '№', textCaps: '3' } },
    { id: 'Digit4', en: { text: '4', textShift: '$', textCaps: '4' }, ru: { text: '4', textShift: ';', textCaps: '4' } },
    { id: 'Digit5', en: { text: '5', textShift: '%', textCaps: '5' }, ru: { text: '5', textShift: '%', textCaps: '5' } },
    { id: 'Digit6', en: { text: '6', textShift: '^', textCaps: '6' }, ru: { text: '6', textShift: ':', textCaps: '6' } },
    { id: 'Digit7', en: { text: '7', textShift: '&', textCaps: '7' }, ru: { text: '7', textShift: '?', textCaps: '7' } },
    { id: 'Digit8', en: { text: '8', textShift: '*', textCaps: '8' }, ru: { text: '8', textShift: '*', textCaps: '8' } },
    { id: 'Digit9', en: { text: '9', textShift: '(', textCaps: '9' }, ru: { text: '9', textShift: '(', textCaps: '9' } },
    { id: 'Digit0', en: { text: '0', textShift: ')', textCaps: '0' }, ru: { text: '0', textShift: ')', textCaps: '0' } },
  ...
  [
    ...
    { id: 'KeyZ', en: { text: 'z', textShift: 'Z', textCaps: 'Z' }, ru: { text: 'я', textShift: 'Я', textCaps: 'Я' } },
    { id: 'KeyX', en: { text: 'x', textShift: 'X', textCaps: 'X' }, ru: { text: 'ч', textShift: 'Ч', textCaps: 'Ч' } },
    { id: 'KeyC', en: { text: 'c', textShift: 'C', textCaps: 'C' }, ru: { text: 'с', textShift: 'С', textCaps: 'С' } },
    { id: 'KeyV', en: { text: 'v', textShift: 'V', textCaps: 'V' }, ru: { text: 'м', textShift: 'М', textCaps: 'М' } },
    { id: 'KeyB', en: { text: 'b', textShift: 'B', textCaps: 'B' }, ru: { text: 'и', textShift: 'И', textCaps: 'И' } },
    { id: 'KeyN', en: { text: 'n', textShift: 'N', textCaps: 'N' }, ru: { text: 'т', textShift: 'Т', textCaps: 'Т' } },
    { id: 'KeyM', en: { text: 'm', textShift: 'M', textCaps: 'M' }, ru: { text: 'ь', textShift: 'Ь', textCaps: 'Ь' } },
    { id: 'Comma', en: { text: ',', textShift: '<', textCaps: ',' }, ru: { text: 'б', textShift: 'Б', textCaps: 'Б' } },
    { id: 'Period', en: { text: '.', textShift: '>', textCaps: '.' }, ru: { text: 'ю', textShift: 'Ю', textCaps: 'Ю' } },
    { id: 'Slash', en: { text: '/', textShift: '?', textCaps: '/' }, ru: { text: '.', textShift: ',', textCaps: '.' } },
...
// Update keyboard keys when CapsLock is on or Shift is pressed
const updateKeys = () => {
  keys.forEach((row) => {
    row.forEach((key) => {
      const keyElement = document.querySelector(`button[id="${key.id}"]`);
      if (isCapsLockOn) {
        keyElement.innerText = key[currentLanguage].textCaps;
      } else if (isShiftPressed) {
        keyElement.innerText = key[currentLanguage].textShift;
      } else {
        keyElement.innerText = key[currentLanguage].text;
      }
    });
  });
};
...
// Highlight keys when pressed on keyboard
window.addEventListener('keydown', (event) => {
  const keyElement = document.querySelector(`button[id="${event.code}"]`);
  if (keyElement) {
